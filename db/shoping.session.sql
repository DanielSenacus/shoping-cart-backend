...
VALUES (
    ...
    (
        'Celular Samsung',
        'Celular Samsung Galaxy A21S 128GB',
        'https://storage.googleapis.com/isometriclove.appspot.com/phone_S_1k.gif',
        500000,
        19,
        7
    ),
    (
        'teclado mecanico',
        'Redragon Teclado mecánico para juegos RGB LED Rainbow retroiluminado',
        'https://storage.googleapis.com/isometriclove.appspot.com/keyboard_S.png',
        45000,
        19,
        8
    ),
    (
        'Nikon d5600',
        'Cámara réflex digital Nikon D5600 con Lente 18-55mm La Nikon D5600',
        'https://storage.googleapis.com/isometriclove.appspot.com/camera.png',
        800000,
        19,
        9
    );
